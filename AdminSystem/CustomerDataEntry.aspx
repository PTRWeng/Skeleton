...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblCustomerEmailAddress" runat="server" style="z-index: 1; left: 19px; top: 265px; position: absolute; width: 155px" Text="Customer Email Address"></asp:Label>
        ...
        <asp:TextBox ID="txtCustomerLastName" runat="server" style="z-index: 1; left: 191px; top: 232px; position: absolute; height: 18px; width: 128px;" ></asp:TextBox>
        <asp:TextBox ID="txtCustomerEmailAddress" runat="server" style="z-index: 1; left: 191px; top: 263px; position: absolute" height="22px" width="128px"></asp:TextBox>
        ...
        <p>
            &nbsp;</p>
        <p>
        <asp:Button ID="btnOk" runat="server" style="z-index: 1; left: 44px; top: 443px; position: absolute; " Text="OK" OnClick="btnOk_Click" />
        </p>
    </form>
</body>
</html>
