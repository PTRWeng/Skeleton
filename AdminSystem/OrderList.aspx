...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ListBox ID="lstorderList" runat="server" style="z-index: 1; left: 26px; top: 37px; position: absolute; height: 313px; width: 699px"></asp:ListBox>
        </div>
        <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 48px; top: 419px; position: absolute" Text="Enter a Order Description"></asp:Label>
