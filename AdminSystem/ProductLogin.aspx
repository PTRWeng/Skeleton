...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 13px; top: 47px; position: absolute" Text="Product Login Page"></asp:Label>
        ...
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 197px; top: 226px; position: absolute" Text="Cancel" />
