...
<body>
   <form id="form1" runat="server">
            <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 13px; top: 47px; position: absolute" Text="Staff Login Page"></asp:Label>
            <asp:Label ID="lblUsername" runat="server" style="z-index: 1; left: 75px; top: 107px; position: absolute" Text="UserName:"></asp:Label>
            <asp:Label ID="lblPassword" runat="server" style="z-index: 1; left: 74px; top: 159px; position: absolute" Text="Password:"></asp:Label>
